// app/components/PDFDocumentSimple.tsx - Wersja bez zewnętrznych czcionek
'use client';
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>ul. Przykladowa 123, 00-000 Warszawa</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <Text style={styles.label}>Wazna do:</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.value}>- Termin platnosci: 30 dni od daty wystawienia faktury</Text>
          <Text style={styles.value}>- Ceny zawieraja VAT</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            <View style={styles.tableHeader}>
              ...
              <Text style={[styles.tableColHeader, { flex: 3 }]}>Opis towaru/uslugi</Text>
              <Text style={styles.tableColHeader}>Ilosc</Text>
              <Text style={styles.tableColHeader}>j.m.</Text>
              <Text style={styles.tableColHeader}>Cena netto</Text>
              <Text style={styles.tableColHeader}>Wartosc netto</Text>
            </View>
            ...
            {offer.additional_costs > 0 && (
              <View style={styles.tableRow}>
                ...
                <Text style={styles.tableCol}>usl</Text>
        ...
        <View style={styles.total}>
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>Wartosc netto:</Text>
        ...
        <View style={{ marginTop: 'auto', paddingTop: 20 }}>
          <Text style={styles.subtitle}>Dziekujemy za zainteresowanie nasza oferta!</Text>
          <Text style={styles.subtitle}>W przypadku pytan prosimy o kontakt telefoniczny lub mailowy.</Text>
        </View>
      </Page>
    </Document>
  );
